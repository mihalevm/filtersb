...
<div>
    ...
    <table style="margin-left: auto; margin-right: auto;" border="0" width="100%">
        ...
        <tr>
            ...
            <td><?=property_exists($egrul,'e')?$egrul->e : 'Не окончена'?></td>
        </tr>
        <tr>
...
<?php if (null !== $scorista) {
    ...
    <?php
        if ( intval($packet->data->cronos->result) > 0 ) {
            ...
            <li>Данные о судимости по заданному перечню статей УК не найдены.</li>
            <li>В федеральном и местном розыске не значится.</li>
            <li>Данные о судимости по прочим статьям/без указания статьи не найдены.</li>
            <li>Административные правонарушения не выявлены.</li>
            <li>Сведения об исполнительном производстве в отношении ФЛ отсутствуют.</li>
            <li>Данные о нарушениях по статьям, связанных с наркотиками, проституцией не найдены.</li>
            <li>Отсутствует в массиве по наркоманам.</li>
            <li>Отсутствует в массиве подучетных лиц.</li>
<?php   } ?>
    </ul>
<?php } ?>
